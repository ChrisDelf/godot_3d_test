...
@onready var projectile_raycast  = $ProjectileRaycast
...
func _fire_ball():
	print("fire_ball")
	var target_position = ((player.transform.origin - marker.transform.origin).normalized())
	projectile_raycast.target_position = target_position
	projectile_raycast.position = marker.global_transform.origin
